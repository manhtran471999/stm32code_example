...
uint8_t SSD1306_Init(void) {
	...
	SSD1306_WRITECOMMAND(0x0); //---set low column address
  ...
  SSD1306_WRITECOMMAND(0xAE); ////////display off
	...
	SSD1306_WRITECOMMAND(0x80); //00,Horizontal Addressing Mode;01,Vertical Addressing Mode;10,Page Addressing Mode (RESET);11,Invalid
	SSD1306_WRITECOMMAND(0xA8); ////////Set Page Start Address for Page Addressing Mode,0-7
	...
	SSD1306_WRITECOMMAND(0xDA); //0xa4,Output follows RAM content;0xa5,Output ignores RAM content
	SSD1306_WRITECOMMAND(0x12); //////-set display offset
	SSD1306_WRITECOMMAND(0x81); //////-not offset
	SSD1306_WRITECOMMAND(0x9f); //////--set display clock divide ratio/oscillator frequency
	SSD1306_WRITECOMMAND(0xCF); //--set divide ratio
	SSD1306_WRITECOMMAND(0xD9); ///////--set pre-charge period
	SSD1306_WRITECOMMAND(0x22); ///////
	SSD1306_WRITECOMMAND(0xDb); ///////--set com pins hardware configuration
	SSD1306_WRITECOMMAND(0xA0); //////
	SSD1306_WRITECOMMAND(0xA4); //////--set vcomh
	SSD1306_WRITECOMMAND(0xA6); //0x20,0.77xVcc
	SSD1306_WRITECOMMAND(0xAF); ////////--turn on SSD1306 panel
	SSD1306_WRITECOMMAND(SSD1306_DEACTIVATE_SCROLL);
